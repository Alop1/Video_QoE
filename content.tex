...
\label{fig:xccs}
\end{figure}
\item letterbox - jest techniką pozwalającą na wywietlanie obrazów o wyższym współczynniku proporcji  na odbiornikach o mniejszym współczynniku proporcji. Polega ona na dołożeniu dwóch czarnych pasów na górze i dole ramki.\cite{letterboxing}
...
\item temporalac
\begin{figure}[h]
\centerline{\includegraphics[ height=5cm, width=9cm]{temporalAC}}
\caption{opis\cite{agh_vqm}}
\label{fig:xccs}
\end{figure}
...
\item blockout
\begin{figure}[h]
\centerline{\includegraphics[ height=5cm, width=9cm]{blackout}}
\caption{opis\cite{agh_vqm}}
\label{fig:xccs}
\end{figure} 
...
\item exposure
\begin{figure}[h]
\centerline{\includegraphics[ height=5cm, width=9cm]{exp}}
\caption{opis\cite{agh_vqm}}
\label{fig:xccs}
\end{figure}
...
\item contrast
\begin{figure}[h]
\centerline{\includegraphics[ height=5cm, width=9cm]{contrastC}}
\caption{opis\cite{agh_vqm}}
\label{fig:xccs}
\end{figure}
...
\item brightness
\begin{figure}[h]
\centerline{\includegraphics[ height=5cm, width=9cm]{brightness}}
\caption{opis\cite{agh_vqm}}
\label{fig:xccs}
\end{figure}
...
\item noise
\begin{figure}[h]
\centerline{\includegraphics[ height=5cm, width=9cm]{noiseC}}
\caption{opis\cite{agh_vqm}}
\label{fig:xccs}
\end{figure}
...
\item slice
\begin{figure}[h]
\centerline{\includegraphics[ height=5cm, width=9cm]{slicingC}}
\caption{opis\cite{agh_vqm}}
\label{fig:xccs}
\end{figure}
