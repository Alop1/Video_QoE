...
\begin{figure}[tbp]
\centerline{\includegraphics[ height=6cm, width=9cm]{psnr_pict}}
\caption{opis}
\label{fig:psnr_pict}
\label{fig:xccs}
\end{figure}
...
\begin{figure}[tbp]
\centerline{\includegraphics[ height=6cm, width=9cm]{svm}}
...
\begin{figure}[tbp]
\centerline{\includegraphics[ height=6cm, width=9cm]{r_tree}}
\caption{opis}
\label{fig:r_tree}
\label{fig:xccs}
\end{figure}
...
\begin{figure}[tbp]
\centerline{\includegraphics[ height=6cm, width=12cm]{nn}}
\caption{opis}
\label{fig:nn}
\label{fig:xccs}
\end{figure}
...
\begin{figure}[tbp]
\centerline{\includegraphics[ height=6cm, width=9cm]{nn_data_2}}
