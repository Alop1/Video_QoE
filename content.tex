...
Kodeki wideo dodatkowo dokonują kompresji na podstawie różnic w ramkach. Różnice te są określane jako wektor ruchu (\emph{ang. motion vector}) i liczone na zasadzie porównania makro-bloku z ramki referencyjnej i tego samego bloku z obecnej ramki \ref{fig:ramki}. Dzięki tej technice po kompresji zatrzymane są  pełne dane tylko o części ramek. Dla odkodowania reszty wystarczą wektory ruchu \cite{kodowanie}. 
