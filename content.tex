...
\begin{figure}[h]
\centerline{\includegraphics[ height=5cm, width=9cm]{blur}}
\caption{opis\cite{agh_vqm}}
\label{fig:xccs}
\end{figure} 
...
\item blackout - opisuje zjawisko kiedy obraz całkowicie zanika\cite{blackout}. Skal przyjęta w pracy : 0-1
\begin{figure}[h]
