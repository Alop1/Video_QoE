...
\begin{itemize}[label=$\bullet$]
	\item SVQ (\emph{ang. Subjective video quality }) -- jakość wideo doświadczana przez człowieka \todo[inline]{Jak ciężko człowiek doświadcza tą biedną jakość? To się kryminał robi z tej pracy ;) }
...
\item Straty bloków ({\em ang. Blockloss}) -- wskaźnik informujący o ilości brakujących bloków (używanych podczas DCT ). Skala przyjęta w pracy: 0-200. Im większa wartość tym większe zniekształcenie obrazu.
