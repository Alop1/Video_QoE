...
Na rysunku \ref{fig:data_preparation_work_flow} został przedstawiony schemat etapów przygotowywania danych. W celu dokonania obliczeń na dużych danych praktycznie każda z czynności dotycząca przetwarzania ich została zautomatyzowana. Kolejne akapity stanowią opis jego elementów.
...
%4\item PSNR
%5\item PSNR, VMAF
%6\item PSNR, VMAF, SSIM, MS-SSIM
%7\item PSNR, VMAF, SSIM, MS-SSIM, blokowość, aktywność przestrzenna, pillarbox, straty bloków, rozmycie, aktywność czasowa, wyciemnienie, ekspozycja, kontrast, jasność, czas trwania, rozdzielczości
%8\item PSNR, VMAF, SSIM, MS-SSIM, blokowość, aktywność przestrzenna, pillarbox, straty bloków, rozmycie, aktywność czasowa, wyciemnienie, ekspozycja, kontrast, jasność, czas trwania, rozdzielczości, liczba dostępnych rozdzielczości
%9\item PSNR, VMAF, SSIM, MS-SSIM, rozmycie, straty bloków
%10\item PSNR, VMAF, SSIM, MS-SSIM, rozmycie, straty bloków, liczba dostępnych rozdzielczości
%11\item PSNR, VMAF, SSIM, MS-SSIM, jasność
%12\item PSNR, VMAF, SSIM, MS-SSIM, jasność, blokowość, straty bloków, rozmycie
%13\item PSNR, VMAF, SSIM, MS-SSIM, jasność, blokowość, straty bloków, rozmycie, liczba dostępnych rozdzielczości
%14\item PSNR, VMAF, SSIM, MS-SSIM, jasność, ekspozycja
%15\item PSNR, VMAF, SSIM, MS-SSIM, jasność, ekspozycja, liczba dostępnych rozdzielczości
%16\item PSNR, VMAF, SSIM, MS-SSIM, jasność, liczba dostępnych rozdzielczości
%17\item PSNR, VMAF, SSIM, MS-SSIM, czas trwania
%18\item PSNR, VMAF, SSIM, MS-SSIM, czas trwania, liczba dostępnych rozdzielczości
%19\item PSNR, VMAF, SSIM, MS-SSIM, czas trwania, liczba dostępnych rozdzielczości, rozdzielczości
%20\item PSNR, SSIM
%21\item SSIM
%22\item blokowość
%23\item blokowość, aktywność przestrzenna, pillarbox, straty bloków, rozmycie, aktywność czasowa, wyciemnienie, ekspozycja, kontrast, jasność, rozdzielczości, liczba dostępnych rozdzielczości
%24\item blokowość, aktywność przestrzenna, pillarbox, straty bloków, rozmycie, aktywność czasowa, wyciemnienie, ekspozycja, kontrast, jasność, czas trwania, rozdzielczości
%25\item blokowość, aktywność przestrzenna, pillarbox, straty bloków, rozmycie, aktywność czasowa, wyciemnienie, ekspozycja, kontrast, jasność, czas trwania, rozdzielczości, liczba dostępnych rozdzielczości
%26\item straty bloków
%27\item rozmycie
%28\item jasność
%29\item kontrast
%30\item ekspozycja
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|}
		\hline
		\textbf{Numer zestawu} & \textbf{Cechy}                                                                                                                                                                                                                                                                 \\ \hline
		1                      & VMAF                                                                                                                                                                                                                                                                           \\ \hline
		2                      & VMAF, SSIM                                                                                                                                                                                                                                                                     \\ \hline
		3                      & MS-SSIM                                                                                                                                                                                                                                                                        \\ \hline
		4                      & PSNR                                                                                                                                                                                                                                                                           \\ \hline
...
\captionof{figure}{Wykres przedstawia stosunek, liczby modeli ocenionych jako bardziej trafnych zbudowanych z zestawów z dodatkową cechą, do liczby przypadków kiedy taki model został oceniony jako gorszy. W 40 przypadkach oceniony, jako lepszy 8 jako gorszy. Rozwarzane zestawy to pary: 14 i 15, 17 i 18, 7 i 8, 11 i 16, 9 i 10, 24 i 25.}
