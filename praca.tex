...
\shorttitlePL{Opracowanie, analiza i ocena algorytmu wyznaczania wartości MOS} % skrócona wersja tytułu jeśli jest bardzo długi
\shorttitleEN{Analysis of an algorithm calculating MOS}
